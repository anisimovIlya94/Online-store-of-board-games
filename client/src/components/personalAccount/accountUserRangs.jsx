  ...
  return (
    <div className={classes.rangsWrapper}>
      ...
      <div className={"d-flex " + classes.rangeItem}>
        ...
        />
        <div>
          <span className={classes.rangeProcents + " " + (bought < 1000 ? classes.disabled : null)}>10%</span>
          <span className={bought < 1000 ? classes.disabled : ""}>"Любитель"</span>
          <div className={classes.rangeItemWrapper}>
            <p className={classes.rangeProcentStatus + " " + (bought < 1000 ? classes.disabled : null)}>{handleStatus("Любитель")}</p>
      ...
      <div className="d-flex">
        ...
        />
        <div>
          <span className={classes.rangeProcents + " " + (bought < 5000 ? classes.disabled : null)}>
            15%
          </span>
          <span className={bought < 5000 ? classes.disabled : ""}>"Профессионал"</span>
          <div className={classes.rangeItemWrapper}>
            <p className={classes.rangeProcentStatus + " " + (bought < 5000 ? classes.disabled : null)}>
